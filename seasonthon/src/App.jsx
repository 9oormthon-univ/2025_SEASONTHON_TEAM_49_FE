...
import S_self_service from "./pages/solution/kiosk/S_self_service";
...
import S_internet from "./pages/solution/phone/S_internet";
import S_kakao from "./pages/solution/phone/S_kakao";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/solution/kiosk/self-service" element={<S_self_service />} />
        ...
        <Route path="/solution/phone/internet" element={<S_internet />} />
        <Route path="/solution/phone/kakao" element={<S_kakao />} />
      </Routes>
    </BrowserRouter>
  );
}
